 ...
 *  
 * Unlike an arraylist only one element is avaliable at a time in a stack
 *
 *
 *
 ...
 **********************************************************************************/
		...
		Stack <String> myStack = new Stack<String>(); // create a stack of strings
		// add objects to the Stack
		// use a stack to process data in reverse order
		myStack.push("Kirk"); // bottom of stack
		myStack.push("Spock");
		myStack.push("McCoy");
		myStack.push("Uhura");
		myStack.push("Scotty");	
		...
		myStack.push("Riker");
		myStack.push("Geordi");
		myStack.push("Data"); // top of stack
		
		System.out.println("Displaying elements in myStack: ");
		
		itemNum = 0;
		for (String item : myStack) { // Processing the stack one element at a time using the for-each loop 
			// for (current element : collection class object) 
			System.out.println("Item @ index #"+itemNum++ + " " + item); // will be in the same order as placed
			}
 ...
 *  The first item in a queue is the first item that was put in there
 *
 *  A lot of methods in common with stack, because they are both types of list
 *  
 *  Some methods:
 *  
 ...
 **********************************************************************************/
		...
		myQueue.add("Josh"); // add the element to the end of the queue
		myQueue.add("Joe");
		myQueue.push("Craig");
		myQueue.push("Yoav") // add the element to the beginning
		myQueue.add("Dan");
		myQueue.add("Mike");
		myQueue.add("Frank");			
