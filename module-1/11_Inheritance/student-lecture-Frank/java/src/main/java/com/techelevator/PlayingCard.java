...
public class PlayingCard {
	...
	public PlayingCard(int value, String suit, String color) {
		this.value = value; // we only use the this. if name = name | so this.name = name | this. represents the current object
		this.suit  = suit;
		this.color = color;
	}
	...
	public String toString() { // extends to the AmericanPlayingCard class | inheritance
