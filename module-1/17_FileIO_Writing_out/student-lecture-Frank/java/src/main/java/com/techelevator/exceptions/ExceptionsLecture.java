...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		String[] cities = new String[] { "Cleveland", "Columbus", "Cincinnati" }; // Array with 3 cities
		try {
		...
		catch(ArrayIndexOutOfBoundsException exceptionObject) {  // an Exception object is automatically thrown to the catch block
			// Flow of control resumes here after the Exception is thrown
			System.out.println("XXX   Uh-oh, something went wrong...   XXX");
			exceptionObject.printStackTrace(); // shows what went wrong 
		}
